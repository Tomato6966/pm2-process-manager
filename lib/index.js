...
exports.existFile = exports.formatBytes = exports.formatPM2Data = exports.Pm2Manager = void 0;
...
class Pm2Manager {
    ...
    findId(process) {
        var _a;
        return (_a = [...this.cache.values()].find((c) => (typeof process === 'string' &&
            c.pm2Name.toLowerCase().replace(' ', '') === process.replace(' ', '').toLowerCase()) ||
            (typeof process === 'number' && process === c.pm2Id))) === null || _a === void 0 ? void 0 : _a.pm2Id;
    }
    /**
...
function formatPM2Data(data) {
    ...
    if (Array.isArray(data))
        return data.map((v) => formatPM2Data(v));
    ...
    return {
        ...
        memoryUsage: {
            ...
            megaBytes: formatBytes(((_o = data.monit) === null || _o === void 0 ? void 0 : _o.memory) || NaN, 2, true),
            formatted: formatBytes(((_p = data.monit) === null || _p === void 0 ? void 0 : _p.memory) || NaN, 2, false),
        },
        pm2Env: Object.assign({}, (data.pm2_env || {})),
    };
}
exports.formatPM2Data = formatPM2Data;
function formatBytes(bytes, decimals = 2, noString = false) {
    if (!+bytes)
        return '0 Bytes';
    const k = 1024;
...
function existFile(path) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, promises_1.access)(path, promises_1.constants.F_OK)
            .then((v) => true)
            .catch(() => false);
    });
}
